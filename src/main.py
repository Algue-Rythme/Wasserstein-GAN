...
def batch_real_distribution(batchSize, i_batch):
    #TODO
    pass

def batch_generated_distribution(generator, batchSize):
     #TODO
     pass
    ...
    for i_epoch in range(nbEpochs):
        for i_batch in range(nbBatchPerEpochs):
            ...
            for i_critic in range(eta_critic):
                clip_weights(critic)
                real_batch = batch_real_distribution(batchSize, i_batch)
                gen_batch = batch_generated_distribution(generator, batchSize)
